...
$gwx_XC_46 = function(_, _v, _n, _p, _s, _wp, _wl, $gwn, $gwl, $gwh, wh, $gstack, $gwrt, gra, grb, TestTest, wfor, _ca, _da, _r, _rz, _o, _oz, _1, _1z, _2, _2z, _m, _mz, nv_getDate, nv_getRegExp, nv_console, nv_parseInt, nv_parseFloat, nv_isNaN, nv_isFinite, nv_decodeURI, nv_decodeURIComponent, nv_encodeURI, nv_encodeURIComponent, $gdc, nv_JSON, _af, _gv, _ai, _grp, _gd, _gapi, $ixc, _ic, _w, _ev, _tsd) {
    return function(path, global) {
        ...
        function gz$gwx_XC_46_1() {
            ...
            return __WXML_GLOBAL__.ops_cached.$gwx_XC_46_1
        }
        __WXML_GLOBAL__.ops_set.$gwx_XC_46 = z;
        __WXML_GLOBAL__.ops_init.$gwx_XC_46 = true;
        var x = ['./miniprogram_npm/@vant/weapp/row/index.wxml'];
        d_[x[0]] = {}
        var m0 = function(e, s, r, gg) {
...
if (__vd_version_info__.delayedGwx || false) $gwx_XC_46();
if (__vd_version_info__.delayedGwx) __wxAppCode__['miniprogram_npm/@vant/weapp/row/index.wxml'] = [$gwx_XC_46, './miniprogram_npm/@vant/weapp/row/index.wxml'];
else __wxAppCode__['miniprogram_npm/@vant/weapp/row/index.wxml'] = $gwx_XC_46('./miniprogram_npm/@vant/weapp/row/index.wxml');

var noCss = typeof __vd_version_info__ !== 'undefined' && __vd_version_info__.noCss === true;
if (!noCss) {
    __wxAppCode__['miniprogram_npm/@vant/weapp/row/index.wxss'] = setCssToHead([
        [2, "./miniprogram_npm/@vant/weapp/common/index.wxss"], ".", [1], "van-row:after{clear:both;content:\x22\x22;display:table}\n",
    ], undefined, {
...
$gwx_XC_47 = function(_, _v, _n, _p, _s, _wp, _wl, $gwn, $gwl, $gwh, wh, $gstack, $gwrt, gra, grb, TestTest, wfor, _ca, _da, _r, _rz, _o, _oz, _1, _1z, _2, _2z, _m, _mz, nv_getDate, nv_getRegExp, nv_console, nv_parseInt, nv_parseFloat, nv_isNaN, nv_isFinite, nv_decodeURI, nv_decodeURIComponent, nv_encodeURI, nv_encodeURIComponent, $gdc, nv_JSON, _af, _gv, _ai, _grp, _gd, _gapi, $ixc, _ic, _w, _ev, _tsd) {
    return function(path, global) {
        ...
        function gz$gwx_XC_47_1() {
            ...
            return __WXML_GLOBAL__.ops_cached.$gwx_XC_47_1
        }
        __WXML_GLOBAL__.ops_set.$gwx_XC_47 = z;
        __WXML_GLOBAL__.ops_init.$gwx_XC_47 = true;
        var x = ['./miniprogram_npm/@vant/weapp/search/index.wxml'];
        d_[x[0]] = {}
        var m0 = function(e, s, r, gg) {
            ...
            if (_oz(z, 34, e, s, gg)) {
                f12.wxVkey = 1
                var h32 = _mz(z, 'slot', ['name', 35, 'slot', 1], [], e, s, gg)
                _(f12, h32)
            }
            var c22 = _v()
            _(oZ2, c22)
            if (_oz(z, 37, e, s, gg)) {
                c22.wxVkey = 1
                var o42 = _mz(z, 'slot', ['name', 38, 'slot', 1], [], e, s, gg)
                _(c22, o42)
            }
            f12.wxXCkey = 1
            c22.wxXCkey = 1
            ...
            if (_oz(z, 40, e, s, gg)) {
                aT2.wxVkey = 1
                var c52 = _mz(z, 'view', ['class', 41, 'hoverClass', 1, 'hoverStayTime', 2], [], e, s, gg)
                var o62 = _v()
                _(c52, o62)
                if (_oz(z, 44, e, s, gg)) {
                    o62.wxVkey = 1
                    var l72 = _n('slot')
                    _rz(z, l72, 'name', 45, e, s, gg)
                    _(o62, l72)
                } else {
                    o62.wxVkey = 2
                    var a82 = _mz(z, 'view', ['bind:tap', 46, 'class', 1], [], e, s, gg)
...
$gwx_XC_48 = function(_, _v, _n, _p, _s, _wp, _wl, $gwn, $gwl, $gwh, wh, $gstack, $gwrt, gra, grb, TestTest, wfor, _ca, _da, _r, _rz, _o, _oz, _1, _1z, _2, _2z, _m, _mz, nv_getDate, nv_getRegExp, nv_console, nv_parseInt, nv_parseFloat, nv_isNaN, nv_isFinite, nv_decodeURI, nv_decodeURIComponent, nv_encodeURI, nv_encodeURIComponent, $gdc, nv_JSON, _af, _gv, _ai, _grp, _gd, _gapi, $ixc, _ic, _w, _ev, _tsd) {
    return function(path, global) {
        ...
        var m0 = function(e, s, r, gg) {
            ...
            var bA3 = _mz(z, 'van-popup', ['round', -1, 'bind:click-overlay', 0, 'bind:close', 1, 'class', 1, 'closeOnClickOverlay', 2, 'duration', 3, 'overlay', 4, 'overlayStyle', 5, 'position', 6, 'safeAreaInsetBottom', 7, 'show', 8, 'zIndex', 9], [], e, s, gg)
            var xC3 = _n('view')
            _rz(z, xC3, 'class', 11, e, s, gg)
            var cF3 = _n('view')
            _rz(z, cF3, 'class', 12, e, s, gg)
            var hG3 = _n('slot')
            _rz(z, hG3, 'name', 13, e, s, gg)
            _(cF3, hG3)
            _(xC3, cF3)
            var oD3 = _v()
            _(xC3, oD3)
            ...
            var oJ3 = _n('view')
            _rz(z, oJ3, 'class', 17, e, s, gg)
            var lK3 = _n('slot')
            _rz(z, lK3, 'name', 18, e, s, gg)
            _(oJ3, lK3)
            _(xC3, oJ3)
            var fE3 = _v()
            _(xC3, fE3)
            ...
            if (_oz(z, 22, e, s, gg)) {
                ...
                var bO3 = function(xQ3, oP3, oR3, gg) {
                    var cT3 = _mz(z, 'options', ['bind:select', 25, 'options', 1, 'showBorder', 2], [], xQ3, oP3, gg)
                    _(oR3, cT3)
                    return oR3
                }
                eN3.wxXCkey = 4
                _2z(z, 23, bO3, e, s, gg, eN3, 'item', 'index', 'index')
            } else {
                oB3.wxVkey = 2
                var hU3 = _mz(z, 'options', ['bind:select', 28, 'options', 1], [], e, s, gg)
                _(oB3, hU3)
            }
            var oV3 = _mz(z, 'button', ['bindtap', 30, 'class', 1, 'type', 2], [], e, s, gg)
        ...
        var m1 = function(e, s, r, gg) {
            ...
            var t13 = function(b33, e23, o43, gg) {
                var o63 = _mz(z, 'view', ['bindtap', 3, 'class', 1, 'data-index', 2], [], b33, e23, gg)
                var f73 = _mz(z, 'button', ['class', 6, 'openType', 1], [], b33, e23, gg)
                var o03 = _mz(z, 'image', ['class', 8, 'src', 1], [], b33, e23, gg)
                _(f73, o03)
                var c83 = _v()
                _(f73, c83)
                if (_oz(z, 10, b33, e23, gg)) {
                    c83.wxVkey = 1
                    var cA4 = _n('view')
                ...
                var h93 = _v()
                _(f73, h93)
                if (_oz(z, 13, b33, e23, gg)) {
                    h93.wxVkey = 1
                    var lC4 = _n('view')
                    _rz(z, lC4, 'class', 14, b33, e23, gg)
                    var aD4 = _oz(z, 15, b33, e23, gg)
                    _(lC4, aD4)
                    _(h93, lC4)
                }
                c83.wxXCkey = 1
            ...
            aZ3.wxXCkey = 2
            _2z(z, 1, t13, e, s, gg, aZ3, 'item', 'index', 'index')
            _(r, lY3)
            return r
        }
        e_[x[1]] = {
...
$gwx_XC_49 = function(_, _v, _n, _p, _s, _wp, _wl, $gwn, $gwl, $gwh, wh, $gstack, $gwrt, gra, grb, TestTest, wfor, _ca, _da, _r, _rz, _o, _oz, _1, _1z, _2, _2z, _m, _mz, nv_getDate, nv_getRegExp, nv_console, nv_parseInt, nv_parseFloat, nv_isNaN, nv_isFinite, nv_decodeURI, nv_decodeURIComponent, nv_encodeURI, nv_encodeURIComponent, $gdc, nv_JSON, _af, _gv, _ai, _grp, _gd, _gapi, $ixc, _ic, _w, _ev, _tsd) {
    return function(path, global) {
        ...
        function gz$gwx_XC_49_2() {
            ...
            return __WXML_GLOBAL__.ops_cached.$gwx_XC_49_2
        }
        ...
        function gz$gwx_XC_49_3() {
            ...
            (function(z) {
                ...
                Z([3, 'id'])
                Z([3, 'onSelectItem'])
                Z([a, [3, 'van-ellipsis content-item-class '],
                    [
                        [12],
                        [
                            [6],
            ...
            return __WXML_GLOBAL__.ops_cached.$gwx_XC_49_3
        }
        __WXML_GLOBAL__.ops_set.$gwx_XC_49 = z;
        __WXML_GLOBAL__.ops_init.$gwx_XC_49 = true;
        var x = ['./miniprogram_npm/@vant/weapp/sidebar-item/index.wxml', './miniprogram_npm/@vant/weapp/sidebar/index.wxml', './miniprogram_npm/@vant/weapp/tree-select/index.wxml'];
        d_[x[0]] = {}
        var m0 = function(e, s, r, gg) {
            var z = gz$gwx_XC_49_1()
            var eF4 = _mz(z, 'view', ['bind:tap', 0, 'class', 1, 'hoverClass', 1, 'hoverStayTime', 2], [], e, s, gg)
            var bG4 = _n('view')
            ...
            if (_oz(z, 5, e, s, gg)) {
                oH4.wxVkey = 1
                var oJ4 = _mz(z, 'van-info', ['dot', 6, 'info', 1], [], e, s, gg)
                _(oH4, oJ4)
            }
            var xI4 = _v()
            _(bG4, xI4)
        ...
        var m2 = function(e, s, r, gg) {
            ...
            var tS4 = _mz(z, 'scroll-view', ['scrollY', -1, 'class', 2], [], e, s, gg)
            var eT4 = _mz(z, 'van-sidebar', ['activeKey', 3, 'bind:change', 1, 'customClass', 2], [], e, s, gg)
            var bU4 = _v()
            _(eT4, bU4)
            var oV4 = function(oX4, xW4, fY4, gg) {
                var h14 = _mz(z, 'van-sidebar-item', ['activeClass', 8, 'badge', 1, 'customClass', 2, 'disabled', 3, 'disabledClass', 4, 'dot', 5, 'title', 6], [], oX4, xW4, gg)
                _(fY4, h14)
                return fY4
            }
            bU4.wxXCkey = 4
            _2z(z, 6, oV4, e, s, gg, bU4, 'item', 'index', 'index')
            _(tS4, eT4)
            _(aR4, tS4)
            var o24 = _mz(z, 'scroll-view', ['scrollY', -1, 'class', 15], [], e, s, gg)
            var c34 = _n('slot')
            _rz(z, c34, 'name', 16, e, s, gg)
            _(o24, c34)
            var o44 = _v()
            _(o24, o44)
            var l54 = function(t74, a64, e84, gg) {
                var o04 = _mz(z, 'view', ['bind:tap', 19, 'class', 1, 'data-item', 2], [], t74, a64, gg)
                var oB5 = _oz(z, 22, t74, a64, gg)
                _(o04, oB5)
                var xA5 = _v()
                _(o04, xA5)
                if (_oz(z, 23, t74, a64, gg)) {
                    xA5.wxVkey = 1
                    var fC5 = _mz(z, 'van-icon', ['class', 24, 'name', 1, 'size', 2], [], t74, a64, gg)
                    _(xA5, fC5)
                }
                xA5.wxXCkey = 1
                xA5.wxXCkey = 3
            ...
            o44.wxXCkey = 4
            _2z(z, 17, l54, e, s, gg, o44, 'item', 'index', 'id')
            _(aR4, o24)
            _(r, aR4)
            return r
        }
    ...
    return function(path, global) {
        ...
        var m0 = function(e, s, r, gg) {
            ...
            if (_oz(z, 0, e, s, gg)) {
                ...
                if (_oz(z, 2, e, s, gg)) {
                    cG5.wxVkey = 1
                    var oH5 = _mz(z, 'view', ['class', 3, 'style', 1], [], e, s, gg)
                    _(cG5, oH5)
                }
                var lI5 = _n('view')
                ...
                if (_oz(z, 6, e, s, gg)) {
                    aJ5.wxVkey = 1
                    var tK5 = _mz(z, 'view', ['class', 7, 'style', 1], [], e, s, gg)
                    _(aJ5, tK5)
                }
                var eL5 = _v()
                _(lI5, eL5)
                var bM5 = function(xO5, oN5, oP5, gg) {
                    var cR5 = _mz(z, 'view', ['class', 12, 'style', 1], [], xO5, oN5, gg)
                    _(oP5, cR5)
                    return oP5
                }
                eL5.wxXCkey = 2
                _2z(z, 10, bM5, e, s, gg, eL5, 'item', 'index', 'index')
                aJ5.wxXCkey = 1
                _(oF5, lI5)
                cG5.wxXCkey = 1
                _(hE5, oF5)
...
$gwx_XC_52 = function(_, _v, _n, _p, _s, _wp, _wl, $gwn, $gwl, $gwh, wh, $gstack, $gwrt, gra, grb, TestTest, wfor, _ca, _da, _r, _rz, _o, _oz, _1, _1z, _2, _2z, _m, _mz, nv_getDate, nv_getRegExp, nv_console, nv_parseInt, nv_parseFloat, nv_isNaN, nv_isFinite, nv_decodeURI, nv_decodeURIComponent, nv_encodeURI, nv_encodeURIComponent, $gdc, nv_JSON, _af, _gv, _ai, _grp, _gd, _gapi, $ixc, _ic, _w, _ev, _tsd) {
    return function(path, global) {
        ...
        function gz$gwx_XC_52_1() {
            ...
            return __WXML_GLOBAL__.ops_cached.$gwx_XC_52_1
        }
        __WXML_GLOBAL__.ops_set.$gwx_XC_52 = z;
        __WXML_GLOBAL__.ops_init.$gwx_XC_52 = true;
        var x = ['./miniprogram_npm/@vant/weapp/sticky/index.wxml'];
        d_[x[0]] = {}
        var m0 = function(e, s, r, gg) {
            var z = gz$gwx_XC_52_1()
            var fI6 = _mz(z, 'view', ['class', 0, 'style', 1], [], e, s, gg)
            var cJ6 = _mz(z, 'view', ['class', 2, 'style', 1], [], e, s, gg)
            var hK6 = _n('slot')
            _(cJ6, hK6)
            _(fI6, cJ6)
            _(r, fI6)
...
if (__vd_version_info__.delayedGwx || false) $gwx_XC_52();
if (__vd_version_info__.delayedGwx) __wxAppCode__['miniprogram_npm/@vant/weapp/sticky/index.wxml'] = [$gwx_XC_52, './miniprogram_npm/@vant/weapp/sticky/index.wxml'];
else __wxAppCode__['miniprogram_npm/@vant/weapp/sticky/index.wxml'] = $gwx_XC_52('./miniprogram_npm/@vant/weapp/sticky/index.wxml');

var noCss = typeof __vd_version_info__ !== 'undefined' && __vd_version_info__.noCss === true;
if (!noCss) {
    __wxAppCode__['miniprogram_npm/@vant/weapp/sticky/index.wxss'] = setCssToHead([
        [2, "./miniprogram_npm/@vant/weapp/common/index.wxss"], ".", [1], "van-sticky{position:relative}\n.", [1], "van-sticky-wrap--fixed{left:0;position:fixed;right:0}\n",
    ], undefined, {

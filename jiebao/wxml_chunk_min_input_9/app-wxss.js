...
$gwx_XC_41 = function(_, _v, _n, _p, _s, _wp, _wl, $gwn, $gwl, $gwh, wh, $gstack, $gwrt, gra, grb, TestTest, wfor, _ca, _da, _r, _rz, _o, _oz, _1, _1z, _2, _2z, _m, _mz, nv_getDate, nv_getRegExp, nv_console, nv_parseInt, nv_parseFloat, nv_isNaN, nv_isFinite, nv_decodeURI, nv_decodeURIComponent, nv_encodeURI, nv_encodeURIComponent, $gdc, nv_JSON, _af, _gv, _ai, _grp, _gd, _gapi, $ixc, _ic, _w, _ev, _tsd) {
    return function(path, global) {
        ...
        var m0 = function(e, s, r, gg) {
            ...
            var x1Z = _mz(z, 'view', ['bind:touchcancel', 0, 'bind:touchend', 1, 'bind:touchstart', 1, 'catch:touchmove', 2, 'class', 3, 'style', 4], [], e, s, gg)
            var o2Z = _n('view')
            _rz(z, o2Z, 'style', 6, e, s, gg)
            var f3Z = _v()
            _(o2Z, f3Z)
            var c4Z = function(o6Z, h5Z, c7Z, gg) {
                var l9Z = _mz(z, 'view', ['bindtap', 10, 'class', 1, 'data-index', 2, 'style', 3], [], o6Z, h5Z, gg)
                var a0Z = _oz(z, 14, o6Z, h5Z, gg)
                _(l9Z, a0Z)
                _(c7Z, l9Z)
                return c7Z
            }
            f3Z.wxXCkey = 2
            _2z(z, 8, c4Z, e, s, gg, f3Z, 'option', 'index', 'index')
            _(x1Z, o2Z)
            _(r, x1Z)
            return r
        }
        ...
        var m1 = function(e, s, r, gg) {
            ...
            if (_oz(z, 2, e, s, gg)) {
                ...
                var cH1 = _n('loading')
                _rz(z, cH1, 'color', 4, e, s, gg)
                _(fG1, cH1)
                _(oD1, fG1)
            }
            var hI1 = _mz(z, 'view', ['catch:touchmove', 5, 'class', 1, 'style', 2], [], e, s, gg)
            var oJ1 = _v()
            _(hI1, oJ1)
            var cK1 = function(lM1, oL1, aN1, gg) {
                var eP1 = _mz(z, 'picker-column', ['activeClass', 10, 'bind:change', 1, 'class', 2, 'customClass', 3, 'data-index', 4, 'defaultIndex', 5, 'initialOptions', 6, 'itemHeight', 7, 'valueKey', 8, 'visibleItemCount', 9], [], lM1, oL1, gg)
                _(aN1, eP1)
                return aN1
            }
            oJ1.wxXCkey = 4
            _2z(z, 8, cK1, e, s, gg, oJ1, 'item', 'index', 'index')
            var bQ1 = _mz(z, 'view', ['class', 20, 'style', 1], [], e, s, gg)
            _(hI1, bQ1)
            var oR1 = _mz(z, 'view', ['class', 22, 'style', 1], [], e, s, gg)
            _(hI1, oR1)
            _(eB1, hI1)
            var xE1 = _v()
            _(eB1, xE1)
...
$gwx_XC_42 = function(_, _v, _n, _p, _s, _wp, _wl, $gwn, $gwl, $gwh, wh, $gstack, $gwrt, gra, grb, TestTest, wfor, _ca, _da, _r, _rz, _o, _oz, _1, _1z, _2, _2z, _m, _mz, nv_getDate, nv_getRegExp, nv_console, nv_parseInt, nv_parseFloat, nv_isNaN, nv_isFinite, nv_decodeURI, nv_decodeURIComponent, nv_encodeURI, nv_encodeURIComponent, $gdc, nv_JSON, _af, _gv, _ai, _grp, _gd, _gapi, $ixc, _ic, _w, _ev, _tsd) {
    return function(path, global) {
        ...
        var x = ['./miniprogram_npm/@vant/weapp/radio-group/index.wxml'];
        d_[x[0]] = {}
        var m0 = function(e, s, r, gg) {
...
if (__vd_version_info__.delayedGwx) __wxAppCode__['miniprogram_npm/@vant/weapp/radio-group/index.wxml'] = [$gwx_XC_42, './miniprogram_npm/@vant/weapp/radio-group/index.wxml'];
else __wxAppCode__['miniprogram_npm/@vant/weapp/radio-group/index.wxml'] = $gwx_XC_42('./miniprogram_npm/@vant/weapp/radio-group/index.wxml');

var noCss = typeof __vd_version_info__ !== 'undefined' && __vd_version_info__.noCss === true;
if (!noCss) {
    __wxAppCode__['miniprogram_npm/@vant/weapp/radio-group/index.wxss'] = setCssToHead([
        [2, "./miniprogram_npm/@vant/weapp/common/index.wxss"], ".", [1], "van-radio-group--horizontal{display:-webkit-flex;display:flex;-webkit-flex-wrap:wrap;flex-wrap:wrap}\n",
    ], undefined, {
...
$gwx_XC_43 = function(_, _v, _n, _p, _s, _wp, _wl, $gwn, $gwl, $gwh, wh, $gstack, $gwrt, gra, grb, TestTest, wfor, _ca, _da, _r, _rz, _o, _oz, _1, _1z, _2, _2z, _m, _mz, nv_getDate, nv_getRegExp, nv_console, nv_parseInt, nv_parseFloat, nv_isNaN, nv_isFinite, nv_decodeURI, nv_decodeURIComponent, nv_encodeURI, nv_encodeURIComponent, $gdc, nv_JSON, _af, _gv, _ai, _grp, _gd, _gapi, $ixc, _ic, _w, _ev, _tsd) {
    return function(path, global) {
        ...
        function gz$gwx_XC_43_1() {
            ...
            return __WXML_GLOBAL__.ops_cached.$gwx_XC_43_1
        }
        __WXML_GLOBAL__.ops_set.$gwx_XC_43 = z;
        __WXML_GLOBAL__.ops_init.$gwx_XC_43 = true;
        var x = ['./miniprogram_npm/@vant/weapp/radio/index.wxml'];
        d_[x[0]] = {}
        var m0 = function(e, s, r, gg) {
            ...
            if (_oz(z, 1, e, s, gg)) {
                cY1.wxVkey = 1
                var l11 = _mz(z, 'view', ['bindtap', 2, 'class', 1], [], e, s, gg)
                var a21 = _n('slot')
                _(l11, a21)
                _(cY1, l11)
            }
            var t31 = _mz(z, 'view', ['bindtap', 4, 'class', 1, 'style', 2], [], e, s, gg)
            var e41 = _v()
            _(t31, e41)
            if (_oz(z, 7, e, s, gg)) {
                e41.wxVkey = 1
                var b51 = _n('slot')
                _rz(z, b51, 'name', 8, e, s, gg)
                _(e41, b51)
            } else {
                e41.wxVkey = 2
                var o61 = _mz(z, 'van-icon', ['class', 9, 'customClass', 1, 'customStyle', 2, 'name', 3, 'style', 4], [], e, s, gg)
                _(e41, o61)
            }
            e41.wxXCkey = 1
            e41.wxXCkey = 3
            ...
            if (_oz(z, 14, e, s, gg)) {
                oZ1.wxVkey = 1
                var x71 = _mz(z, 'view', ['bindtap', 15, 'class', 1], [], e, s, gg)
                var o81 = _n('slot')
                _(x71, o81)
                _(oZ1, x71)
            }
...
$gwx_XC_44 = function(_, _v, _n, _p, _s, _wp, _wl, $gwn, $gwl, $gwh, wh, $gstack, $gwrt, gra, grb, TestTest, wfor, _ca, _da, _r, _rz, _o, _oz, _1, _1z, _2, _2z, _m, _mz, nv_getDate, nv_getRegExp, nv_console, nv_parseInt, nv_parseFloat, nv_isNaN, nv_isFinite, nv_decodeURI, nv_decodeURIComponent, nv_encodeURI, nv_encodeURIComponent, $gdc, nv_JSON, _af, _gv, _ai, _grp, _gd, _gapi, $ixc, _ic, _w, _ev, _tsd) {
    return function(path, global) {
        ...
        var x = ['./miniprogram_npm/@vant/weapp/rate/index.wxml'];
        d_[x[0]] = {}
        var m0 = function(e, s, r, gg) {
            var z = gz$gwx_XC_44_1()
            var c01 = _mz(z, 'view', ['bind:touchmove', 0, 'class', 1], [], e, s, gg)
            var hA2 = _v()
            _(c01, hA2)
            var oB2 = function(oD2, cC2, lE2, gg) {
                var tG2 = _mz(z, 'view', ['class', 4, 'style', 1], [], oD2, cC2, gg)
                var bI2 = _mz(z, 'van-icon', ['bind:click', 6, 'class', 1, 'color', 2, 'customClass', 3, 'data-score', 4, 'name', 5, 'style', 6], [], oD2, cC2, gg)
                _(tG2, bI2)
                var eH2 = _v()
                _(tG2, eH2)
                if (_oz(z, 13, oD2, cC2, gg)) {
                    eH2.wxVkey = 1
                    var oJ2 = _mz(z, 'van-icon', ['bind:click', 14, 'class', 1, 'color', 2, 'customClass', 3, 'data-score', 4, 'name', 5, 'style', 6], [], oD2, cC2, gg)
                    _(eH2, oJ2)
                }
                eH2.wxXCkey = 1
                eH2.wxXCkey = 3
            ...
            hA2.wxXCkey = 4
            _2z(z, 2, oB2, e, s, gg, hA2, 'item', 'index', 'index')
            _(r, c01)
            return r
        }
        e_[x[0]] = {

    ...
    return function(path, global) {
        ...
        function gz$gwx_XC_63_1() {
            ...
            (function(z) {
                ...
                Z([3, 'navTo'])
                Z([3, 'link'])
                Z([3, '/pages/webview/index?url=https%3A%2F%2Fwww.apple.com%2Flegal%2Finternet-services%2Fitunes%2Fdev%2Fstdeula%2F'])
                Z([3, '用户协议'])
                Z(z[57])
                Z(z[58])
                Z([3, '/pages/webview/index?url=https%3A%2F%2Fs.cantonesepi.top%2Fhtml%2FappWeb%2Fprivacy-policy.html'])
                Z([3, '隐私政策'])
            })(__WXML_GLOBAL__.ops_cached.$gwx_XC_63_1);

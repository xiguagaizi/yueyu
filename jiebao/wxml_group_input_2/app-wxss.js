...
$gwx_XC_18 = function(_, _v, _n, _p, _s, _wp, _wl, $gwn, $gwl, $gwh, wh, $gstack, $gwrt, gra, grb, TestTest, wfor, _ca, _da, _r, _rz, _o, _oz, _1, _1z, _2, _2z, _m, _mz, nv_getDate, nv_getRegExp, nv_console, nv_parseInt, nv_parseFloat, nv_isNaN, nv_isFinite, nv_decodeURI, nv_decodeURIComponent, nv_encodeURI, nv_encodeURIComponent, $gdc, nv_JSON, _af, _gv, _ai, _grp, _gd, _gapi, $ixc, _ic, _w, _ev, _tsd) {
    return function(path, global) {
        ...
        var x = ['./miniprogram_npm/@vant/weapp/config-provider/index.wxml'];
        d_[x[0]] = {}
        var m0 = function(e, s, r, gg) {
            var z = gz$gwx_XC_18_1()
            var a4R = _mz(z, 'view', ['class', 0, 'style', 1], [], e, s, gg)
            var t5R = _n('slot')
            _(a4R, t5R)
            _(r, a4R)
            return r
...
if (__vd_version_info__.delayedGwx) __wxAppCode__['miniprogram_npm/@vant/weapp/config-provider/index.wxml'] = [$gwx_XC_18, './miniprogram_npm/@vant/weapp/config-provider/index.wxml'];
else __wxAppCode__['miniprogram_npm/@vant/weapp/config-provider/index.wxml'] = $gwx_XC_18('./miniprogram_npm/@vant/weapp/config-provider/index.wxml');

var noCss = typeof __vd_version_info__ !== 'undefined' && __vd_version_info__.noCss === true;
if (!noCss) {
    __wxAppCode__['miniprogram_npm/@vant/weapp/config-provider/index.wxss'] = setCssToHead([], undefined, {
        path: "./miniprogram_npm/@vant/weapp/config-provider/index.wxss"
    });
}
} catch (e) {}
try {
...
$gwx_XC_22 = function(_, _v, _n, _p, _s, _wp, _wl, $gwn, $gwl, $gwh, wh, $gstack, $gwrt, gra, grb, TestTest, wfor, _ca, _da, _r, _rz, _o, _oz, _1, _1z, _2, _2z, _m, _mz, nv_getDate, nv_getRegExp, nv_console, nv_parseInt, nv_parseFloat, nv_isNaN, nv_isFinite, nv_decodeURI, nv_decodeURIComponent, nv_encodeURI, nv_encodeURIComponent, $gdc, nv_JSON, _af, _gv, _ai, _grp, _gd, _gapi, $ixc, _ic, _w, _ev, _tsd) {
    return function(path, global) {
        ...
        var m0 = function(e, s, r, gg) {
            ...
            if (_oz(z, 0, e, s, gg)) {
                oDT.wxVkey = 1
                var xET = _mz(z, 'view', ['class', 1, 'style', 1], [], e, s, gg)
                var oFT = _mz(z, 'van-popup', ['bind:after-enter', 3, 'bind:after-leave', 1, 'bind:close', 2, 'bind:enter', 3, 'bind:leave', 4, 'closeOnClickOverlay', 5, 'customStyle', 6, 'duration', 7, 'overlay', 8, 'overlayStyle', 9, 'position', 10, 'rootPortal', 11, 'safeAreaTabBar', 12, 'show', 13], [], e, s, gg)
                var fGT = _v()
                _(oFT, fGT)
                var cHT = function(oJT, hIT, cKT, gg) {
                    var lMT = _mz(z, 'van-cell', ['clickable', -1, 'bind:tap', 19, 'class', 1, 'data-option', 2, 'icon', 3], [], oJT, hIT, gg)
                    var tOT = _mz(z, 'view', ['class', 23, 'slot', 1, 'style', 2], [], oJT, hIT, gg)
                    var ePT = _oz(z, 26, oJT, hIT, gg)
                    _(tOT, ePT)
                    _(lMT, tOT)
                    var aNT = _v()
                    _(lMT, aNT)
                    if (_oz(z, 27, oJT, hIT, gg)) {
                        aNT.wxVkey = 1
                        var bQT = _mz(z, 'van-icon', ['class', 28, 'color', 1, 'name', 2], [], oJT, hIT, gg)
                        _(aNT, bQT)
                    }
                    aNT.wxXCkey = 1
                    aNT.wxXCkey = 3
                ...
                fGT.wxXCkey = 4
                _2z(z, 17, cHT, e, s, gg, fGT, 'item', 'index', 'value')
                var oRT = _n('slot')
                _(oFT, oRT)
                _(xET, oFT)
                _(oDT, xET)
